...
public static class DispatcherRegistration
   {
       ...
       public static IServiceCollection AddDispatcher(this IServiceCollection services, Assembly assembly)
       {
           ...
           services.AddScoped<Shared.Dispatcher.Dispatcher>();
           services.AddScoped<ISender>(sp => sp.GetRequiredService<Shared.Dispatcher.Dispatcher>());
           services.AddScoped<IPublisher>(sp => sp.GetRequiredService<Shared.Dispatcher.Dispatcher>());
